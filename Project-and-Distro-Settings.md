...
You can also automatically create a patch in a *different* project for
each pull request opened in the repository as well as each subsequent
...
!\[pr_testing.png\](images/pr_testing.png)
...
\"upstream\" project) to kick of a child patch (in the \"downstream\"
...
section to kick of a child patch for each pull request opened in the
...
-   Interval: Evergreen will run the specified tasks every X hours, with
...
!\[distros.png\](images/distros.png)
...
Settings defined on the project page will take precedence over those
defined in the yaml. If a project is configured to use repo level
settings, the merged result of the project page and repo settings will
be what takes precedence over the yaml properties. If something is set
for a given setting on the project page, it must be removed before a
project\'s runtime configuration reflects what is defined in the project
yaml.
...
[View setting
definition](https://github.com/evergreen-ci/evergreen/wiki/Project-and-Distro-Settings#performance-plugin)
